        ...
        <section className="max-w-5xl m-auto flex flex-col min-h-screen bg-background text-foreground font-sans">
            <div className="flex items-center justify-center flex-1 px-5 py-12">
                <div className="text-center w-full max-w-md">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center text-background">
                        <Link to="/dashboard" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary text-background font-semibold shadow-md hover:opacity-90 active:opacity-80 transition-all">
