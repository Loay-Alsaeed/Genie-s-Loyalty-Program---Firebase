...
const BattleBase = () => {
    ...
    return (
        <section className="max-w-5xl m-auto flex flex-col min-h-screen bg-background text-foreground font-sans ">
            <div className="pt-5 px-5 pb-4 bg-linear-to-b from-primary/10 to-background">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-primary to-primary/80 p-5 shadow-lg shadow-primary/20">
                    ...
                    <div className="relative z-10 text-background">
                        <p className="background text-xl mb-1 font-bold">Your Points Balance</p>
                        <div className="flex items-center gap-2">
                            <Icon icon="solar:crown-star-bold" className="size-8 background" />
                            <h2 className="text-4xl font-bold background font-heading">{user?.score || 0}</h2>
                            <span className="background text-lg font-bold">XP</span>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div className="flex gap-4 justify-center items-center">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center justify-between mt-3">
                                                    ...
                                                    {/* <button className="px-4 py-1.5 rounded-lg bg-primary text-background font-semibold text-sm active:opacity-90">
                                                        Redeem
                                                    </button> */}
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/20 text-primary font-bold text-sm h-fit">
