    ...
    return (
        ...
        <section className="max-w-5xl m-auto flex flex-col min-h-screen bg-background text-foreground font-sans ">
            <div className="flex items-center justify-between px-5 py-4 border-b border-border">
                <Link to={"/dashboard"} className="flex items-center justify-center size-10 rounded-full bg-white/20 text-foreground transition-colors active:scale-95">
                    ...
                    {sortedUsers.length !== 0 &&
                        sortedUsers.slice(3, 10).map((player, idx) =>
                            player.id === user.uid ? (
                                ...
                                >
                                    <div className="flex items-center justify-center size-10 rounded-full bg-white/20 text-foreground font-bold text-lg">
                                        {idx + 4}
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        <p className="font-bold text-primary text-xl">{player.score}</p>
                                    </div>
                                </div>
                            )
                        )
