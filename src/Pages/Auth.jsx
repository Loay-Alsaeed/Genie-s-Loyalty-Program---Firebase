            ...
            <div className="flex items-center justify-center flex-1 px-5 py-12">
                <div className="w-full max-w-md">
                    <div className="p-6 md:p-8 rounded-2xl bg-card border border-border shadow-md">
                        ...
                        <div className="flex mb-6 bg-secondary rounded-xl p-1 transition-all duration-300">
                            <button
                                onClick={() => {
                                    setActiveTab("signin");
                                    setError("");
                                }}
                                className={`flex-1 py-3 rounded-lg transition-all duration-300 font-semibold cursor-pointer text-sm ${activeTab === "signin"
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 rounded-lg transition-all duration-300 font-semibold cursor-pointer text-sm ${activeTab === "signup"
                                        ? "bg-primary text-background shadow-md"
                                        : "text-background "
                                    }`}
                            >
                        ...
                        {error && (
                            <div className="mb-4 text-sm text-foreground bg-destructive/30 border border-destructive rounded-xl p-3 text-center">
                                {error}
                            </div>
                        )}
